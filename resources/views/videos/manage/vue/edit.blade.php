<x-casteaching-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{__('Edicio del video ').$video->title}}</h2>
    </x-slot>
        ...
        @can('videos_manage_create')
            ...
            <div class="lg:grid bg-white md:bg-transparent  lg:grid-cols-12 lg:gap-x-5 mt-5">
                ...
                <div class="space-y-6 sm:px-6 lg:col-span-9 lg:px-0">
                    ...
                    <form class="px-4 py-5" data-qa="form_video_edit" action="" METHOD="POST">
                        @csrf
                        @method('PUT')
                        <div class="shadow sm:overflow-hidden sm:rounded-md">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input
                                            ...
                                            type="text" name="title" id="title" value="{{$video->title}}">
                                    </div>
                            ...
                            <textarea type="text" name="description" id="description" rows="10"
                                      class="block w-full  rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{$video->description}}</textarea>
                                    </div>
